...
1.) If this is assigned to a group, only one member will submit.  The other member will be assigned the "[partner grade] C-assembly interface" assignment.

2.) Submission via GitHub.  Place your Github link in the next question. Make sure I can access your GitHub.

3.) Write the name of all group members in the Github documentation.
